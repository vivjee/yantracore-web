...
export const TRACKS: Track[] = [
  ...
  { id: 6, title: "Flute Beats", duration: "7:59", isPlayable: true, src: "/music/flute-beats.mp3", description: "Breathy flute melodies woven over a steady, unhurried lo-fi beat.", tempo: "82 BPM", key: "E Minor" },
  { id: 7, title: "Glass Cursor", duration: "3:02", isPlayable: true, src: "/music/glass-cursor.mp3", description: "Crystalline glass tones gliding over a hushed ambient pulse.", tempo: "70 BPM", key: "B Minor" },
  { id: 8, title: "Neon Tape Delay", duration: "2:59", isPlayable: true, src: "/music/neon-tape-delay.mp3", description: "Neon-lit dub textures smeared through warm analog tape delay.", tempo: "75 BPM", key: "A Minor" },
  { id: 9, title: "Sky of Juniper", duration: "5:29", isPlayable: true, src: "/music/sky-of-juniper.mp3", description: "Wide, evergreen ambient drift beneath an open evening sky.", tempo: "62 BPM", key: "D Major" },
  { id: 10, title: "Tideglass", duration: "2:44", isPlayable: true, src: "/music/tideglass.mp3", description: "Glassy tidal swells lapping in slow, meditative waves.", tempo: "66 BPM", key: "G Minor" },
];
