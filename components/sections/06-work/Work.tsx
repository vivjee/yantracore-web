        ...
        <Reveal delay={240}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {clientProjects.map((project, pi) => {
              const accentColors = [
                "var(--accent-1)", "var(--accent-2)", "var(--accent-warm)",
                "var(--accent-3)", "var(--accent-1)", "var(--accent-2)",
              ];
              ...
              return (
                <button
                  ...
                  className="text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-1 rounded-3xl group"
                    ...
                    <div className="flex flex-col gap-3 h-full relative z-10">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {project.tags.map((tag) => (
                          <span
                            key={tag}
                            className="text-[9px] font-mono uppercase tracking-wider px-2 py-0.5 rounded-full border border-white/10 text-text-faint"
                          >
                            {tag}
                          </span>
                        ))}
